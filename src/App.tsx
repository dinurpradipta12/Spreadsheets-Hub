...
function TrialLockedPage({ workspace, trialExpiresAt }: { workspace: Workspace; trialExpiresAt?: string }) {
  ...
  return (
    <div className="trial-modal-backdrop">
      <div className="trial-modal-content trial-locked-modal">
        ...
        <p className="trial-locked-hint">Hubungi kami untuk mengaktifkan kembali workspace Anda.</p>
...
function TrialExpiredModal({ workspace, trialExpiresAt, onAcknowledge }: { workspace: Workspace; trialExpiresAt?: string; onAcknowledge: () => void }) {
  ...
  return (
    <div className="trial-modal-backdrop">
      <div className="trial-modal-content trial-expired-modal">
        ...
        <p className="trial-expired-hint">Segera lakukan pembayaran agar workspace bisa diaktifkan kembali.</p>
